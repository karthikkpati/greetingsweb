...
public enum GenericEnum {
	...
	INVALID_USERNAME_PASSWORD("0008", "Invalid Username or password"), USER_DOESNT_EXIST("0009","Username doesnt exist"), INVALID_EVENT_STATUS("0010","Invalid Event Status");
