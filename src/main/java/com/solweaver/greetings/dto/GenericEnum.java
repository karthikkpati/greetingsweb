...
public enum GenericEnum {
	...
	INVALID_INVITEE_STATUS("0016","Invalid Invitee Status"), INVALID_INVITEE_RECIPIENT("0017","Invitee list cannot have receiver email"), USER_EVENT_ORDER_IS_REQUIRED("0018","Order is required to make greeting");
