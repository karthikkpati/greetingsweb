...
public enum GenericEnum {
	...
	SENDER_EMAIL_FAILED("0019", "Email sending failed"), INVALID_SOCIAL_AUTH_PROVIDER("0020", "Social Auth provider is Invalid"), NOTIFICATION_TEMPLATE_DOESNT_EXIST("0021", "Notification Template Does Not Exist"), NOTIFICATION_NAME_EMPTY("0022", "Notification Name cannot be empty");
